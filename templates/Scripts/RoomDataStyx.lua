RoomSetData.Styx =
{
	BaseStyx =
	{
		...
		FishingPointRequirements =
		{
			...
			RequiredMinRoomsSinceFishingPoint = @fishing_room_space|10@,
		},
	...
	D_Boss01 =
	{
		...
		RewardConsumableOverrides =
		{
			...
			AddResources =
			{
				MetaPoints = @boss_darkness_scale|250@,
			},
		},
		EntranceDirection = "Right",
		...
		FishingPointChance = @fishing_chance|0.20@,
		FishingPointRequirements =
		{
			RequiredCosmetics = { "FishingUnlockItem" },
			RequiredMinRoomsSinceFishingPoint = @fishing_room_space|1@,
	...
	D_Hub =
	{
		...
		FishingPointChance = @fishing_chance|0.30@,
		FishingPointRequirements =
		{
			RequiredCosmetics = { "FishingUnlockItem" },
			RequiredMinRoomsSinceFishingPoint = @fishing_room_space|1@,
