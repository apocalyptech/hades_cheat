	...
	D_WorldShop =
	{
		GroupsOf =
		{
			...
			},
			{
				...
				OptionsData =
				{
					{ Name = "HermesUpgradeDrop", Cost = 500, UpgradeChance = 1.0, UpgradedCost = @shop_cost_scale|500@, ReplaceRequirements = { RequiredTextLines = {  "HermesFirstPickUp" },}},
					{ Name = "ChaosWeaponUpgrade", Cost = @shop_cost_scale|650@ },
