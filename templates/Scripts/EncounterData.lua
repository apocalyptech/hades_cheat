...
EncounterData =
{
	...
	Shop =
	{
		...
		{
			{ FunctionName = "SpawnRoomReward" },
			{ FunctionName = "CheckForbiddenShopItem", GameStateRequirements = { ChanceToPlay = @charon_shoplift_chance|0.22@, RequiredMinRunsCleared = 1, CurrentRunValueFalse = "ForbiddenShopItemOffered", } },
		},
		DistanceTriggers =
		{
			{
