ConsumableData =
{
	...
	MetaDropRange =
	{
		...
		CostPerMetaPoint = @well_darkness_cost_scale|0.75@,
		AddResources =
		{
			MetaPoints =
			{
				BaseMin = @well_darkness_scale|20@,
				BaseMax = @well_darkness_scale|30@,
				AsInt = true,
			},
		},
		UseText = "UseTakeItem",
	...
	GemDropRange =
	{
		...
		Icon = "Shop_Treasure",
		-- OnPurchaseSound = "/Leftovers/Menu Sounds/WellPurchase_Crystal",
		CostPerGem = @well_gem_cost_scale|2.5@,
		AddResources =
		{
			Gems =
			{
				BaseMin = @well_gem_scale|10@,
				BaseMax = @well_gem_scale|15@,
				AsInt = true,
			},
		},
		UseText = "UseTakeItem",
	...
	SuperGiftDrop =
	{
		...
		Cost = @shop_cost_scale|1100@,
		Icon = "SuperGiftIconSmall",
		AddResources =
		{
			SuperGiftPoints = @ambrosia_qty|1@,
		},
	...
	MoneyDrop =
	{
		...
		Cost = 0,
		DropMoney = {
			BaseMin = @money_qty|100@,
			BaseMax = @money_qty|100@,
			DepthMult = 0.05,
			AsInt = true,
		},
	...
	RoomRewardMaxHealthDrop =
	{
		...
		Cost =
		{
			BaseValue = @shop_cost_scale|125@,
			DepthMult = 0,
			AsInt = true,
		},
		AddMaxHealth = @maxhealth_qty|25@,
	...
	RoomRewardMetaPointDrop =
	{
		...
		AddResources =
		{
			MetaPoints = @darkness_reward_qty|10@,
		},
		SpawnSound = "/SFX/Player Sounds/DarknessRewardDrop",
		ConsumeSound = "/SFX/Player Sounds/DarknessCollectionPickup",
	...
	StoreRewardMetaPointDrop =
	{
		...
		AddResources =
		{
			MetaPoints = @shop_darkness_qty|25@,
		},
	},
	...
	GemDrop =
	{
		...
		Cost =
		{
			BaseValue = @shop_cost_scale|50@,
			DepthMult = 0,
			AsInt = true,
		},
		AddResources =
		{
			Gems = @various_gems_qty|5@,
		},
	...
	GemDropRunProgress =
	{
		...
		DropMoney =
		{
			BaseMin = @gems_extra_money_qty|20@,
			BaseMax = @gems_extra_money_qty|20@,
			AsInt = true,
		},
	},
	...
	SuperGemDrop =
	{
		...
		Cost =
		{
			BaseValue = @super_shop_cost_scale|1000@,
			DepthMult = 0,
			AsInt = true,
		},
		AddResources =
		{
			SuperGems = @diamonds_qty|1@,
		},
	...
	SuperLockKeyDrop =
	{
		...
		Cost =
		{
			BaseValue = @super_shop_cost_scale|1200@,
			DepthMult = 0,
			AsInt = true,
		},
		AddResources =
		{
			SuperLockKeys = @titan_blood_qty|1@,
		},
